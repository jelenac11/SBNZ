                                            ...
                                            <v-card>
                                                ...
                                                <v-list dense>
                                                    <v-list-item v-for="(key, index) in filteredKeys" :key="index">
                                                        ...
                                                        <v-list-item-content class="align-end" :class="{ 'green--text': sortBy === key }">
                                                            <span>
                                                                <b>
                                                                    {{ item[key.toLowerCase()] }}<span v-if="key === 'Proteins' || key === 'Carbs' || key === 'Fats'">g</span>
                                                                </b>
                                                            </span>
                                                        </v-list-item-content>
                                                    </v-list-item>
...
<script>
    ...
    export default {
        ...
        computed: {
            numberOfPages () {
                return Math.ceil(this.groceries.length / this.itemsPerPage)
            },
            filteredKeys () {
        ...
        created() {
            this.$store.dispatch('getAllGroceriesAdmin');
        }
    }
</script>
